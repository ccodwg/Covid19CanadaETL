...
dl_datasets <- function(mode = c("main", "phu")) {
  ...
  # function: add specific xlsx sheets to dataset
  add_xlsx_sheet <- function(ds, uuid, sheet) {
  ...
  if (mode == "main") {
    # pe
    ds <- add_xlsx_sheet(ds, "3ff94c42-8b12-4653-a6c9-0ddd8ff343d5", "Total Doses")
    ds <- add_xlsx_sheet(ds, "3ff94c42-8b12-4653-a6c9-0ddd8ff343d5", "Fully Immunized")
  } else {
    # Toronto (TOR)
    ds <- add_xlsx_sheet(ds, "ebad185e-9706-44f4-921e-fc89d5cfa334", "Status")
  }
